                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select class="form-control" name="status" required="required" aria-required="true">
                                <option disabled="null">Select Vendor Status</option>
                                <option value="0" <?php if($status==0) echo 'selected="selected"';?>>Not Verified</option>
                                <option value="1" <?php if($status==1) echo 'selected="selected"';?>>Verified</option>
                            </select>
                        </div>
                    </div>
                </div>
