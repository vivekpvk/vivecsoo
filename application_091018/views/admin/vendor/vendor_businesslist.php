      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/vendor/vendordetail/saveDetail">
             <input type="hidden" value="<?php echo $selectedcat->user_id;?>" name="user_id" />
          <?php
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- display pdf/image -->
                        <button class="btn btn-primary"><a style="color: white;" href="<?php echo base_url();?>upload/<?= $selectedcat->logo_image?>">View Logo</a></button>
                        <!-- end here -->
                         <input type="hidden" value="<?php echo $selectedcat->id;?>" name="vendor_id" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- display pdf/image -->
                        <button class="btn btn-primary"><a style="color: white;" href="<?php echo base_url();?>upload/<?= $selectedcat->pro_image?>">View Product</a></button>
                        <!-- end here -->
                         <input type="hidden" value="<?php echo $selectedcat->id;?>" name="vendor_id" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- display pdf/image -->
                        <button class="btn btn-primary"><a style="color: white;" href="<?php echo base_url();?>upload/<?= $selectedcat->license_image?>">View License</a></button>
                        <!-- end here -->
                         <input type="hidden" value="<?php echo $selectedcat->id;?>" name="vendor_id" />
                    </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- display pdf/image -->
                        <button class="btn btn-primary"><a style="color: white;" href="<?php echo base_url();?>upload/<?= $selectedcat->gst_image?>">View Gst</a></button>
                        <!-- end here -->
                         <input type="hidden" value="<?php echo $selectedcat->id;?>" name="vendor_id" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- display pdf/image -->
                        <button class="btn btn-primary"><a style="color: white;" href="<?php echo base_url();?>upload/<?= $selectedcat->pan_image?>">View Pan</a></button>
                        <!-- end here -->
                         <input type="hidden" value="<?php echo $selectedcat->id;?>" name="vendor_id" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- display pdf/image -->
                        <button class="btn btn-primary"><a style="color: white;" href="<?php echo base_url();?>upload/<?= $selectedcat->aadhar_image?>">View Aadhar</a></button>
                        <!-- end here -->
                         <input type="hidden" value="<?php echo $selectedcat->id;?>" name="vendor_id" />
                    </div>
                </div>
                <?php
                 if ($selectedcat->user_id=1) {?>
