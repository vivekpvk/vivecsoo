                ...
                <table  id="pagin" class="table table-striped js-dataTable-full display">
                  ...
                  <tbody>
                     <?php foreach ($list as $post) 
                                    { ?>
                    <tr class='clickable-row' data-href="<?php echo base_url();?>admin/vendor/vendordetail/vendorBusinesslist/<?=$post->user_id?>">
                      ...
                      ?></td>
                      <td>
                        <a class="btn btn-default btn-rounded btn-condensed btn-sm"  data-toggle="tooltip"  title="Verify" href="<?=base_url()?>admin/vendor/vendordetail/verify_vendor/<?=$post->id?>"><i class="fa fa-check-circle" style="font-size:30px;color:green"></i></a>

                        <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip"  title="Unverify" href="<?=base_url()?>admin/vendor/vendordetail/unverify_vendor/<?=$post->user_id?>"><i class="fa fa-times" style="font-size:30px;color:red"></i></a>
                                           
                        <a  class="delete btn btn-default btn-rounded btn-condensed btn-sm" href="<?=base_url()?>admin/vendor/vendordetail/Delete_vendor/<?=$post->user_id?>" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="font-size:30px;color:red"></i></a>
                      </td>
                      <?php } ?>
